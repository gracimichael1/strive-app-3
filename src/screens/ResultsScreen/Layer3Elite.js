    ...
    >
      ...
      {gradedSkills.length > 0 && (() => {
        ...
        const stats = [
          ...
          { label: 'Best', val: bestGrade, color: GRADE_COLOR_MAP[bestGrade] || COLORS.gold, bg: 'rgba(232,150,42,0.05)', border: 'rgba(232,150,42,0.15)' },
        ];
        return (
      ...
      {/* Skills header */}
      <div style={{ padding: '20px 20px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <h2 style={{ fontSize: 15, fontWeight: 700, color: 'rgba(255,255,255,0.3)', fontFamily: "'Outfit', sans-serif", margin: 0, letterSpacing: 1, textTransform: 'uppercase' }}>Skill-by-Skill Breakdown</h2>
        {skillFilter !== 'all' && (
